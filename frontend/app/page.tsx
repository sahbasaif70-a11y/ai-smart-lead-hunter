      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center p-6 py-12 lg:p-10 lg:px-18 ">
        ...
        <div className="text-center lg:text-left space-y-6 md:space-y-8 ">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            <Link href="scan" className="w-full sm:w-auto">
              <button className="w-full sm:w-auto bg-gradient-to-r from-cyan-400 to-blue-700 hover:opacity-90 text-white px-8 py-3 rounded-lg font-bold transition-all shadow-lg shadow-blue-500/20 text-sm uppercase tracking-widest">
                Start Scanning
              </button>
            </Link>
            <button className="w-full sm:w-auto flex items-center justify-center gap-2 text-white border border-white/10 rounded-lg hover:bg-white/5 font-semibold px-7 py-3 transition-all text-sm">
        ...
        <div className="relative px-6 py-4 md:px-10 md:py-4 rounded-[32px] border border-white/14 bg-[#020617]/40 backdrop-blur-2xl shadow-[0_0_50px_-8px_rgba(34,211,238,0.3)] max-w-md w-full mx-auto lg:justify-self-end">
          <div className="flex justify-between items-center mb-6 md:mb-8">
            ...
            <div className="text-gray-500 text-[10px] md:text-[12px] font-bold tracking-widest uppercase">AI OCR</div>
          </div>

          {/* SCANNING AREA */}
          <div className="relative p-4 md:p-8 bg-gradient-to-br from-[#02071c] to-[#020617] rounded-2xl border border-white/14 mb-6 overflow-hidden">
            {/* Viewfinder Corners */}
            ...
            {/* Inner Card */}
            <div className="relative bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-xl p-4 md:p-6 shadow-2xl border border-white/10 overflow-hidden">
              <div className="animate-scan"></div>
              <div className="flex justify-between items-start">
                <div className="space-y-3 md:space-y-4">
                  <div>
                    <h4 className="text-white text-base md:text-lg font-bold">Alex Morgan</h4>
                    <p className="text-[10px] md:text-xs text-cyan-400 mt-0.5">Sales Manager</p>
                  </div>
                  <div className="space-y-2 text-[9px] md:text-[11px] text-gray-400">
                    <div className="flex items-center gap-2"><span>📧</span> alex@example.com</div>
                    <div className="flex items-center gap-2"><span>🌐</span> www.scanvault.com</div>
                    <div className="flex items-center gap-2"><span>📍</span> New York, USA </div>
                  </div>
                </div>
          ...
          <div className="flex justify-between items-center px-2">
            <div className="flex text-[9px] md:text-[10px] text-emerald-400 items-center gap-2">
